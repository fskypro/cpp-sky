...
#define GEN_EVENT_ARG_1(cls, type1, name1) \
	FS_SMP_STRUCT_1(cls, NS_FS::EventArg, type1, name1)

#define GEN_EVENT_ARG_2(cls, type1, name1, type2, name2) \
	FS_SMP_STRUCT_2(cls, NS_FS::EventArg, type1, name1, type2, name2)

#define GEN_EVENT_ARG_3(cls, type1, name1, type2, name2, type3, name3) \
	FS_SMP_STRUCT_3(cls, NS_FS::EventArg, type1, name1, type2, name2, type3, name3)

#define GEN_EVENT_ARG_4(cls, type1, name1, type2, name2, type3, name3, type4, name4) \
	FS_SMP_STRUCT_4(cls, NS_FS::EventArg, type1, name1, type2, name2, type3, name3, type4, name4)

#define GEN_EVENT_ARG_5(cls, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5) \
	FS_SMP_STRUCT_5(cls, NS_FS::EventArg, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5)
...
{
public:
	typedef void (T::*Handler)(T*, EventConstArg&);
...
private:
	...
	inline void fire(T* pSender, EventConstArg& arg)
	{
